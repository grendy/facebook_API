...
class Gtoken():
    ...
    def start_requests(self):
        global token, parameter,account, cout, inisial
        ...
        time.sleep(2)
        driver.find_element_by_xpath('//*[@id="email"]').send_keys("sarahningtyas@gmail.com")
        time.sleep(1)
        ...
        try:
            cout = "select count(*)from malaysia where api ='update2'"
            sql = "select url from malaysia where api ='update2'"
            cur.execute(sql)
            cou.execute(cout)
